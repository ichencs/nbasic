...
void TestReadonlyDictionary(const Dictionary<nint, nint>& dictionary, nint* keys, nint* values, nint count)
{
...
void TestSortedDictionary(Dictionary<nint, nint>& dictionary)
{
	dictionary.Clear();
...
void TestReadonlyGroup(const Group<nint, nint>& group, nint* keys, nint* values, nint* counts, nint count)
{
...
void TestSortedGroup(Group<nint, nint>& group)
{
	group.Clear();
...
{
	Dictionary<nint, nint> dictionary;
	TestSortedDictionary(dictionary);
}

TEST_CASE(TestGroup)
{
	Group<nint, nint> group;
