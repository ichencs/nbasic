...
#include "../Collections/Dictionary.h"
		...
		/// </summary>
		class NIStream : public virtual Interface
		{
		public:
			...
			virtual nint					Read(void* _buffer, nint _size)=0;
			...
			virtual nint					Write(void* _buffer, nint _size)=0;
			...
			virtual nint					Peek(void* _buffer, nint _size)=0;
		};
		...
		public:
			...
			virtual void					Setup(NIStream* _stream)=0;
