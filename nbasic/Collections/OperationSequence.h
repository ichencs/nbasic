...
class TakeEnumerator : public virtual IEnumerator<T>
{
	protected:
		...
		nint					count;
	public:
		TakeEnumerator(IEnumerator<T>* _enumerator, nint _count)
...
class SkipEnumerator : public virtual IEnumerator<T>
{
	protected:
		...
		bool					skipped;
	public:
		SkipEnumerator(IEnumerator<T>* _enumerator, nint _count, bool _skipped = false)
			: enumerator(_enumerator)
			, count(_count)
			, skipped(_skipped)
		{
...
class RepeatEnumerator : public virtual IEnumerator<T>
{
	protected:
		...
		nint					repeatedCount;
	public:
		RepeatEnumerator(IEnumerator<T>* _enumerator, nint _count, nint _index = -1, nint _repeatedCount = 0)
			: enumerator(_enumerator)
			, count(_count)
			, index(_index)
