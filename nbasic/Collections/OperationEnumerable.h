...
nint CompareEnumerable(const IEnumerable<T>& a, const IEnumerable<U>& b)
{
...
{
	static bool Contains(const NSortedList<T>& items, const T& item)
	{
...
{
	static bool Contains(const NSortedList<Ptr<T>>& items, const Ptr<T>& item)
	{
