...
class RegexMatch : public Object, private NotCopyable
{
	...
	public:
		...
		typedef NList<Ref>								List;
		typedef NList<RegexString>						CaptureList;
		typedef NGroup<WString, RegexString>			CaptureGroup;
	protected:
		NList<RegexString>				captures;
		NGroup<WString, RegexString>	groups;
		bool										success;
		RegexString									result;
...
class RegexLexerWalker : public Object
{
	...
	public:
		...
		nint										GetRelatedToken(nint state)const;
		...
		void										Walk(wchar_t input, nint& state, nint& token, bool& finalState, bool& previousTokenStop)const;
		/// <summary>Step forward by one character.</summary>
		/// <returns>Returns the new current state.</returns>
		/// <param name="input">The input character.</param>
		/// <param name="state">The current state.</param>
		nint										Walk(wchar_t input, nint state)const;
		...
		bool										IsClosedToken(const wchar_t* input, nint length)const;
